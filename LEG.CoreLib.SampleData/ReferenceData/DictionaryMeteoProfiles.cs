        ...
        public DictionaryMeteoProfiles()
        {
            MeteoDict = new Dictionary<string, MeteoProfile>(StringComparer.OrdinalIgnoreCase)
            {
                ...
                [Bos_cha_meteo_S] = new MeteoProfile(Bos_cha_meteo_S, 2, "meteo8",
                    [0.1695, 0.2105, 0.49875, 0.65455, 0.646, 0.646, 0.642, 0.622, 0.58805, 0.44925, 0.25905, 0.1585]),
                ...
                [Ligist_meteo] = new MeteoProfile(Ligist_meteo, 2, "meteo2",
                    [0.329, 0503, 0.556, 0.533, 0.45, 0.541, 0.54, 0.515, 0.541, 0.452, 0.27, 0.251]),
                ...
                // Test entries
                [TestProfile] = new MeteoProfile(TestProfile, 4, "TestOwnerMeteo",
